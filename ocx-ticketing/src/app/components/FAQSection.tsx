...
export default function FAQSection({ lang }: { lang: "vi" | "en" }) {
  ...
  return (
    <section id="faq" className="py-16 bg-[#fff8f2] dark:bg-[#1a1a1a]">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="space-y-4">
          {FAQS.map((f, i) => (
            <div key={i} className="border rounded-lg overflow-hidden bg-white dark:bg-black">
              <button
                className="w-full flex justify-between items-center px-4 py-3 text-left font-semibold text-black dark:text-white focus:outline-none"
              ...
              {open === i && (
                <div className="px-4 pb-4 text-gray-700 dark:text-gray-200 animate-fade-in">
                  {f.a[lang]}
                </div>
              )}
            </div>
